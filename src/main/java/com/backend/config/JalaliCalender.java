...
public class JalaliCalender extends Calendar{
    ...
    public JalaliCalender(TimeZone zone) {
        this(zone, Locale.getDefault());
    }

    public JalaliCalender(Locale aLocale) {
        this(TimeZone.getDefault(), aLocale);
    }

    public JalaliCalender(TimeZone zone, Locale aLocale) {
    ...
    public JalaliCalender(int year, int month, int dayOfMonth) {
        this(year, month, dayOfMonth, 0, 0, 0, 0);
    }

    public JalaliCalender(int year, int month, int dayOfMonth, int hourOfDay,
                          int minute) {
    ...
    JalaliCalender(int year, int month, int dayOfMonth,
    ...
    public static int weekOfYear(int dayOfYear, int year) {
        switch (dayOfWeek(JalaliCalender.jalaliToGregorian(new YearMonthDate(year, 0, 1)))) {
            case 2:
                dayOfYear++;
                break;
            case 3:
